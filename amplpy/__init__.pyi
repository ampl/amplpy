...
class Variables:
    ...
    @overload
    def __setitem__(self, name: str, value: Real) -> None: ...
    @overload
    def __setitem__(self, name: str, value: Iterable[Real]) -> None: ...
    @overload
    def __setitem__(self, name: str, value: Mapping[Any, Real]) -> None: ...
    def __setitem__(self, name: str, value: Union[Real, Iterable[Real], Mapping[Any, Real]]) -> None: ...
...
class Parameters:
    ...
    @overload
    def __setitem__(self, name: str, value: Union[Real, str]) -> None: ...
    @overload
    def __setitem__(self, name: str, value: Mapping[Any, Real]) -> None: ...
    @overload
    def __setitem__(self, name: str, value: Iterable[Tuple[Any, Real]]) -> None: ...
    @overload
    def __setitem__(self, name: str, value: Iterable[Real]) -> None: ...
    def __setitem__(self, name: str, value: Union[Real, str, Mapping[Any, Real], Iterable[Tuple[Any, Real]], Iterable[Real]]) -> None: ...
...
class AMPL:
    ...
    def get_value(self, scalar_expression: str) -> Optional[int, float, str]: ...
    def getValue(self, scalar_expression: str) -> Optional[int, float, str]: ...
    ...
    @property
    def solve_result(self) -> Optional[int, float, str]: ...
    @property
    def solve_result_num(self) -> Optional[int, float, str]: ...
    @overload
    ...
    def get_iis(self, flat: bool = True) -> Tuple[Dict[str, Any], Dict[str, Any]]: ...    @overload
    ...
    def get_solution(self, flat: bool = True, zeros: bool = ...) -> Dict[str, Any]: ...    def _start_recording(self, filename: str) -> None: ... #might be also path
