...
cdef class Variable(Entity):
    ...
    def value(self):
        ...
        """
        cdef double value
        campl.AMPL_InstanceGetDoubleSuffix(self._c_ampl, self._name.encode('utf-8'), self._index, campl.AMPL_NUMERICSUFFIX.VALUE, &value)
        return value
    ...
    def defeqn(self):
        ...
        """
        cdef int value
        campl.AMPL_InstanceGetIntSuffix(self._c_ampl, self._name.encode('utf-8'), self._index, campl.AMPL_NUMERICSUFFIX.DEFEQN, &value)
        return value
    ...
    def init(self):
        ...
        """
        cdef double value
        campl.AMPL_InstanceGetDoubleSuffix(self._c_ampl, self._name.encode('utf-8'), self._index, campl.AMPL_NUMERICSUFFIX.INIT, &value)
        return value
    ...
    def init0(self):
        ...
        """
        cdef double value
        campl.AMPL_InstanceGetDoubleSuffix(self._c_ampl, self._name.encode('utf-8'), self._index, campl.AMPL_NUMERICSUFFIX.INIT0, &value)
        return value
    ...
    def lb0(self):
        ...
        """
        cdef double value
        campl.AMPL_InstanceGetDoubleSuffix(self._c_ampl, self._name.encode('utf-8'), self._index, campl.AMPL_NUMERICSUFFIX.LB0, &value)
        return value
    ...
    def ub0(self):
        ...
        """
        cdef double value
        campl.AMPL_InstanceGetDoubleSuffix(self._c_ampl, self._name.encode('utf-8'), self._index, campl.AMPL_NUMERICSUFFIX.UB0, &value)
        return value
    ...
    def lb1(self):
        ...
        """
        cdef double value
        campl.AMPL_InstanceGetDoubleSuffix(self._c_ampl, self._name.encode('utf-8'), self._index, campl.AMPL_NUMERICSUFFIX.LB1, &value)
        return value
    ...
    def ub1(self):
        ...
        """
        cdef double value
        campl.AMPL_InstanceGetDoubleSuffix(self._c_ampl, self._name.encode('utf-8'), self._index, campl.AMPL_NUMERICSUFFIX.UB1, &value)
        return value
    ...
    def lb2(self):
        ...
        """
        cdef double value
        campl.AMPL_InstanceGetDoubleSuffix(self._c_ampl, self._name.encode('utf-8'), self._index, campl.AMPL_NUMERICSUFFIX.LB2, &value)
        return value
    ...
    def ub2(self):
        ...
        """
        cdef double value
        campl.AMPL_InstanceGetDoubleSuffix(self._c_ampl, self._name.encode('utf-8'), self._index, campl.AMPL_NUMERICSUFFIX.UB2, &value)
        return value
    ...
    def lrc(self):
        ...
        """
        cdef double value
        campl.AMPL_InstanceGetDoubleSuffix(self._c_ampl, self._name.encode('utf-8'), self._index, campl.AMPL_NUMERICSUFFIX.LRC, &value)
        return value
    ...
    def urc(self):
        ...
        """
        cdef double value
        campl.AMPL_InstanceGetDoubleSuffix(self._c_ampl, self._name.encode('utf-8'), self._index, campl.AMPL_NUMERICSUFFIX.URC, &value)
        return value
    ...
    def rc(self):
        ...
        """
        cdef double value
        campl.AMPL_InstanceGetDoubleSuffix(self._c_ampl, self._name.encode('utf-8'), self._index, campl.AMPL_NUMERICSUFFIX.RC, &value)
        return value
