...
cdef class DataFrameArrow:
    ...
    cdef void init_from_arrow(self, const campl.ArrowSchema* schema_ptr, const campl.ArrowArray* array_ptr):
        cdef campl.AMPL_ERRORINFO* errorinfo
        errorinfo = campl.AMPL_DataFrameArrowCreate(&self._c_df, schema_ptr, array_ptr)
        if errorinfo:
    ...
    def from_polars(cls, df):
        ...
        obj.init_from_arrow(arrow_schema_ptr, arrow_array_ptr)
        return obj
